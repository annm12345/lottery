<?php
require('top.inc.php');
$msg='ငွေထုတ်ယူမှုအတွက်အချက်အလက်များအတည်ပြပါ';
...
if(isset($_SESSION['LOT_USER_LOGIN'])) {
    ...
    if(isset($_POST['cashout'])){            
            ...
            $date = date('Y-m-d');
            $time = date('h:i:s');
            $check = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM `point` WHERE `uid`='$user_id'"));
            $point=$check['amount'];
            if ($point < 0) {
            ...
            <?php
                ...
                <script>
                    window.location.href="index.php";
                    window.alert('လူကြီးမင်းတွင်လက်ကျန်ငွေအလုံအလောက်မရှိပါ');
...
?>
  ...
  <div class="banner">
    <div class="header-main">
       ...
       <form action="" method="post" class="cash-container" enctype="multipart/form-data" id="cashout" >
            <div class="img-container">           
            </div>
            
            <div class="amount"> 
                <span>ထုတ်ယူမည့်ဖုန်းနံပါတ်</span>
                <input type="number" name="phone" id="" placeholder="***********" style="width:100px;text-align:center;border:none;outline:none;" required>
            </div>
            <div class="amount"> 
                <span>ထုတ်ယူမည့်အမည်</span>
                <input type="text" name="name" id="" placeholder="***********" style="width:100px;text-align:center;border:none;outline:none;" required>
            </div>
            <div class="amount"> 
                <span>ထုတ်ယူမည့်ငွေပမာဏ(ဂဏန်းဖြင့်)</span>
                <input type="number" name="amount" id="" placeholder="******" style="width:100px;text-align:center;border:none;outline:none;" required>
            </div>
            <div class="amount"> 
            ...
            <input type="submit" name="cashout" class="btn-primary" value="ငွေထုတ်မည်">
       </form>
    </div>
</div>
