    ...
    <nav class="desktop-navigation-menu">
      ...
      <div class="container">
        ...
        <ul class="desktop-menu-category-list">
                ...
                <li class="menu-category">
                    <a href="buy_ticket.php" class="menu-title">ထီပေါက်စဉ်ထည့်မည်</a>
                </li>
                <li class="menu-category">
                    <a href="check_prize_prize.php" class="menu-title">ထီတိုက်မည်</a>
                </li>
                <li class="menu-category">
                ...
                <li class="menu-category">
                    <a href="cashin.php" class="menu-title">ငွေသွင်း <span class="count" style="margin-left:1rem;background:red;color:#fff;padding:3px 10px;border-radius:50%;">
                    <?php
                     echo $request_count = mysqli_num_rows(mysqli_query($con, "SELECT * FROM `cashin` WHERE `comfirm`=''"));
                    ?>
                  </span></a>
                </li>
                <li class="menu-category">
                    <a href="cashout.php" class="menu-title">ငွေထုတ် <span class="count" style="margin-left:1rem;background:red;color:#fff;padding:3px 10px;border-radius:50%;">
                    <?php
                     echo $request_count = mysqli_num_rows(mysqli_query($con, "SELECT * FROM `cashout` WHERE `comfirm`=''"));
                    ?>
                  </span></a>
                </li>
                <li class="menu-category">
                    <a href="forget.php" class="menu-title">စကားဝှက်အသစ်တောင်းဆိုမှုများ <span class="count" style="margin-left:1rem;background:red;color:#fff;padding:3px 10px;border-radius:50%;">
                    <?php
                     echo $request_count = mysqli_num_rows(mysqli_query($con, "SELECT * FROM `forget` WHERE `comfirm`=''"));
                    ?>
                  </span></a>
                </li>
    ...
    <div class="mobile-bottom-navigation">
      ...
      <button class="action-btn" data-mobile-menu-open-btn>
        ...
        <a href="cashin.php" class="action-btn">
            <div style="display: flex; flex-direction: column; align-items: center;">
                <span class="count" id="count-cashin"><?php
                     echo $request_count = mysqli_num_rows(mysqli_query($con, "SELECT * FROM `cashin` WHERE `comfirm`=''"));
                    ?></span>
        ...
        <a href="cashout.php" class="action-btn">
            <div style="display: flex; flex-direction: column; align-items: center;">
                <span class="count" id="count-cashout"><?php
                     echo $request_count = mysqli_num_rows(mysqli_query($con, "SELECT * FROM `cashout` WHERE `comfirm`=''"));
                    ?></span>
            ...
            function fetchCounts() {
                ...
                xhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        document.querySelector('#count-cashin').innerText = response.cashin_count;
                        document.querySelector('#count-cashout').innerText = response.cashout_count;

                        var mobileMenuCountCashin = document.querySelectorAll('.menu-category a[href="cashin.php"] .count');
                        mobileMenuCountCashin.forEach(function(span) {
                            span.innerText = response.cashin_count;
                        });

                        var mobileMenuCountCashout = document.querySelectorAll('.menu-category a[href="cashout.php"] .count');
                        mobileMenuCountCashout.forEach(function(span) {
                            span.innerText = response.cashout_count;
                        });
                        var mobileMenuCountrequest = document.querySelectorAll('.menu-category a[href="foregt.php"] .count');
                        mobileMenuCountCashout.forEach(function(span) {
                            span.innerText = response.cashout_count;
                        });
                    }
                };
                xhttp.open("GET", "cash_count.php", true);
                xhttp.send();
            }
