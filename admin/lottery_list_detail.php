            ...
            <div class="result_container">
                <?php
                    if(isset($_GET['amount']) && isset($_GET['type']) && isset($_GET['date'])) {
                        ...
                        $type = $_GET['type'];
                        $date = $_GET['date'];
                        $res = mysqli_query($con, "SELECT * FROM `list` WHERE `amount`='$amount' AND `type`='$type' AND `title`='$date'");
                ...
                ?>
                        <div class="list_container">
                            ...
                            <div class="first_lottery">
                                ...
                                <p style="color:darkblue;font-weight:600;"><?php if($row['sell']=='true'){echo 'ရောင်းချပြီး';} ?></p>
